...
\begin{itemize}
\item Trava solenoide 12V;
\item Fonte DC 12V (figura \ref{trava};
...
\item[4] Ao final da contagem a GPIO4 volta para o nível lógico. Neste momento, ao encostar a porta, esta será trancada.
